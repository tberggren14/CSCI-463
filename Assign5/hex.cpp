...
/**
This function must return a std::string with 3 hex digits representing the 32 bits of the i
argument.
 *
 * @param i a 8 bit unsigned hex number used for address in vector
 * @return string
 * prints the int as a hex  
 ********************************************************************************/
string hex::to_hex12(uint32_t i)
{
...
/**
This function must return a std::string with 5 hex digits representing the 32 bits of the i
argument.
 *
 * @param i a 8 bit unsigned hex number used for address in vector
 * @return string
 * prints the int as a hex  
 ********************************************************************************/
string hex::to_hex20(uint32_t i)
{
...
/**
This function must return a std::string beginning with 0x, followed by the 5 hex digits representing 
 *
...
{
   return std::string("0x")+to_hex12(i);
...
{
    return std::string("0x")+to_hex20(i);
